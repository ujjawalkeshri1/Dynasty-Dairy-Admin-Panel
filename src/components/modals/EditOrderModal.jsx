...
export function EditOrderModal({ open, onClose, onSave, order }) {
  ...
  const handleUpdateOrder = () => {
    ...
    const updatedOrder = {
      ...
      branch: customer?.branch || order.branch,
    };
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">Edit order details and status</DialogDescription>
        </DialogHeader>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              {customerSearch && filteredCustomers.length > 0 && (() => {
                ...
                const isCurrentCustomer = currentCustomer && currentCustomer.name.toLowerCase().includes(customerSearch.toLowerCase());
                
                if (isCurrentCustomer) return null;
